...
Intended features:
-Tiled map. Possibly generated, possibly designed
-Player plane stays central in screen and map scrolls underneath
-Player health
-64 pixel sprites and tiles
...
-UI showing health, ammo and fuel
